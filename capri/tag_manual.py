...
class TagManual(ft.UserControl):
    ...
    def build(self):
        ...
        self.Tag_manual = ft.Container(
            ft.Column(
                [
                    ft.Container(
                        ft.Column(
                            [
                                ft.Text('Tag Manual', size= 50, color= ft.colors.BLACK, weight= ft.FontWeight.W_800),
                                ft.Text('Ingresa el número de Tag que deseas generar.', size= 20, weight= ft.FontWeight.W_700, color= ft.colors.BLACK, font_family='fonts/Poppins/Poppins-Black.ttf')
                            ]
                        ),
                        width= 800,
                        height=150,
