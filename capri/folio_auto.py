...
class FolioAutomatico(ft.UserControl):
    ...
    def build(self):
        ...
        self.folio_automatico = ft.Container(
            ft.Column(
                [
                    ft.Container(
                        ft.Column(
                            [
                                ft.Text('Folio Automatico', size= 50, color= ft.colors.BLACK, weight= ft.FontWeight.W_800),
                                ft.Text('Añade el número de folio incial y el final.', size= 20, weight= ft.FontWeight.W_700, color= ft.colors.BLACK, font_family='fonts/Poppins/Poppins-Black.ttf')
                            ]
                        ),
                        width= 800,
                        height=150,
                    ...
                    ft.Text('Folios generados', weight= ft.FontWeight.W_700, color= ft.colors.GREY_400, size=20),
                    ft.Container(
                        width=800,
                        height=100,
